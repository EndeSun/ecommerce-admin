...
@endguest
    ...
    <section class="header-nav">
        <img class="w-25 h-25" src="https://images.assetsdelivery.com/compings_v2/lumut/lumut1511/lumut151100229.jpg" alt="logo">
...
@endguest
    ...
    @guest
    <section>
        <img id="logo-img" src="https://images.assetsdelivery.com/compings_v2/lumut/lumut1511/lumut151100229.jpg" alt="logo">
    </section>
    @else
    <button id="menu-icon">
