...
<table class="table">
    ...
    <tbody>
        @foreach( $arrayCategorias as $categoria )
            <tr>
                <th scope="row"><img
                        ...
                        alt="Imagen categoría" width="35rem" class="img-fluid"></th>
        ...
        <form action="{{ url('categoria/edit', ['id' => $categoria->id])}}" method="POST" enctype="multipart/form-data"> <!-- Tipo de codificación para enviar ficheros -->
        @method('PUT')
        @csrf
        <div class="modal fade modal-xl" id="modal-{{$categoria->id}}" tabindex="-1" aria-labelledby="modalLabel-{{$categoria->id}}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <figure class="col-4 col-md-2 col-lg-1">
                                <img src="{{asset($categoria->imagen)}}" alt="foto_categoria" width="80rem" class="img-fluid">
                            </figure>
